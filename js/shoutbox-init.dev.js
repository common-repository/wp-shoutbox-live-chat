        ...
        jQuery("div.shoutbox-container").each(function(){
            ...
            (Shoutbox.user_status == 2 && guests_visible == 1)
                ...
                if(Shoutbox.no_participation == 1){
                    ...
                    string += '<textarea class="shoutbox-message"></textarea>';

                    if(smilies == 1){
                        string += '<div class="shoutbox-smilies-container">';
                        for(var smile in Shoutbox['smilies'])
                            string += '<div class="shoutbox-smile-container shoutbox-smile"><img title="'+smile+'" src="'+Shoutbox['smilies'][smile]+'" alt="'+Shoutbox['smilies'][smile]+'"/></div>'
                        string += '</div>';
                    }
